...
> **Warning: This is a beta release.** Vorpalstacks is under active development. While all supported AWS services (list in [docs/services.md](docs/services.md)) are implemented, with over 3,000 passing Go tests (SDK, cross-service integration, and WebSocket suites, plus 631 Python, 2028 TypeScript, and 2019 C# tests), not all edge cases and AWS behaviours are fully covered. Expect breaking changes. Bug reports and contributions are welcome.
...
- **Service Integration**: Event-driven communication between services with 65 cross-service integration tests
...
This architecture enables sub-millisecond latencies for core operations, making it practical to run extensive API tests (over 3,000 Go tests across the SDK, integration, and WebSocket suites, plus 631 Python, 2028 TypeScript, and 2019 C# tests) directly within CI/CD pipelines without containerization overhead.
