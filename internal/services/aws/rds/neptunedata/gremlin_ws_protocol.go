...
// MIME types for TinkerPop Gremlin Server message framing.
const (
	mimeGraphSON3  = "application/vnd.graphson-v3+json"
	mimeGraphSON3U = "application/vnd.graphson-v3+octet-stream"
	mimeGraphBin   = "application/vnd.graphbinary-v1.0"
)
...
func newGremlinAuthResponse(requestID string) GremlinResponse {
	return GremlinResponse{
		RequestID: requestID,
		Status: StatusMsg{
			Code:       statusAuthenticate,
			Message:    "",
			Attributes: map[string]interface{}{},
		},
		Result: ResultMsg{
