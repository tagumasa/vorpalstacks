...
// buildTypeRefObjectVisited constructs a __Type reference from an ast.Type.
// GraphQL introspection wraps NonNull and List types in nested ofType
// structures: {"kind":"NON_NULL","name":null,"ofType":{...}}.
func (e *graphQLEngine) buildTypeRefObjectVisited(schema *ast.Schema, t *ast.Type, visited map[string]bool) map[string]interface{} {
	...
	return map[string]interface{}{"kind": typeKindString(def.Kind), "name": named}
}
