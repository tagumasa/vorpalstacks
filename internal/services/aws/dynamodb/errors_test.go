...
func TestDynamoDBErrors(t *testing.T) {
	...
	t.Run("predefined errors", func(t *testing.T) {
		...
		assert.Equal(t, http.StatusBadRequest, ErrItemNotFound.GetHTTPStatusCode())
