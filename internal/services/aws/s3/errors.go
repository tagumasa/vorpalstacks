...
var (
	...
	ErrObjectLockNotEnabled = awserrors.NewAWSError("InvalidRequest", "Object Lock is not enabled for this bucket", http.StatusBadRequest)
	...
	ErrObjectLockedRetention = awserrors.NewAWSError("AccessDenied", "Object is locked by retention policy", http.StatusForbidden)
)
