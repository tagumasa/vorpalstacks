...
func (e *ResourceExtractor) registerEventBridgeExtractors() {
	...
	for _, op := range operations {
		e.Register("eventbridge", op, eventsExtractor)
	}
	...
	for _, op := range []string{"CreateEventBus", "DeleteEventBus"} {
		e.Register("eventbridge", op, eventsBusExtractor)
	}

	e.Register("eventbridge", "ListEventBuses", func(params map[string]interface{}, accountID, region string) string {
...
func (e *ResourceExtractor) registerCloudWatchExtractors() {
	...
	e.Register("monitoring", "*", func(params map[string]interface{}, accountID, region string) string {
