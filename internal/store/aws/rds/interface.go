...
type InstanceSnapshotOps interface {
	CreateInstanceSnapshot(snapshot *DBInstanceSnapshot) error
	GetInstanceSnapshot(id string) (*DBInstanceSnapshot, error)
	UpdateInstanceSnapshot(snapshot *DBInstanceSnapshot) error
	DeleteInstanceSnapshot(id string) error
	ListInstanceSnapshots() ([]*DBInstanceSnapshot, error)
}
