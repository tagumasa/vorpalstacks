...
func NewNeptuneStore(store storage.BasicStorage) *NeptuneStore {
	...
	return &NeptuneStore{
		...
		clusterEndpoints: common.NewProtoStore(common.ProtoStoreConfig[DBClusterEndpoint]{
			...
			ToDomain: func(m proto.Message) (*DBClusterEndpoint, error) {
				return ProtoToClusterEndpoint(m.(*pb.DBClusterEndpoint)), nil
			},
			ToProto:      func(d *DBClusterEndpoint) (proto.Message, error) { return ClusterEndpointToProto(d), nil },
