...
func NewNeptuneGraphStore(store storage.BasicStorage) *NeptuneGraphStore {
	return &NeptuneGraphStore{
		graphs: common.NewProtoStore(common.ProtoStoreConfig[Graph]{
			...
			ToDomain:     func(m proto.Message) (*Graph, error) { return protoToGraph(m.(*pb.Graph)), nil },
			ToProto:      func(d *Graph) (proto.Message, error) { return graphToProto(d), nil },
		...
		importTasks: common.NewProtoStore(common.ProtoStoreConfig[ImportTask]{
			...
			ToDomain:     func(m proto.Message) (*ImportTask, error) { return protoToImportTask(m.(*pb.ImportTaskRecord)), nil },
			ToProto:      func(d *ImportTask) (proto.Message, error) { return importTaskToProto(d), nil },
		...
		exportTasks: common.NewProtoStore(common.ProtoStoreConfig[ExportTask]{
			...
			ToDomain:     func(m proto.Message) (*ExportTask, error) { return protoToExportTask(m.(*pb.ExportTaskRecord)), nil },
			ToProto:      func(d *ExportTask) (proto.Message, error) { return exportTaskToProto(d), nil },
