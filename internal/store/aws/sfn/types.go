...
// TaskStateEnteredEventDetails contains details emitted when a Task state is entered.
type TaskStateEnteredEventDetails struct {
	Input string `json:"input"`
	Name  string `json:"name"`
}

// TaskStateExitedEventDetails contains details emitted when a Task state is exited.
type TaskStateExitedEventDetails struct {
	Output string `json:"output"`
	Name   string `json:"name"`
}
