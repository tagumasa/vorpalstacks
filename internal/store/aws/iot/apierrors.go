...
var (
	...
	ErrAlarmModelNotFound               = awserrors.NewAWSError("ResourceNotFoundException", "The specified resource does not exist.", 404)
	ErrAlarmModelAlreadyExists          = awserrors.NewAWSError("ResourceAlreadyExistsException", "The resource already exists.", 409)
