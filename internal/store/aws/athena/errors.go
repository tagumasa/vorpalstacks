...
var (
	...
	// ErrCapacityReservationNotFound is returned when the specified capacity
	// reservation does not exist.
	ErrCapacityReservationNotFound = errors.New("capacity reservation not found")

	// ErrCapacityReservationAlreadyExists is returned when attempting to create
	// a capacity reservation that already exists.
	ErrCapacityReservationAlreadyExists = errors.New("capacity reservation already exists")
)
