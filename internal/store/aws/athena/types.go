...
// CapacityReservationStatus represents the status of a capacity reservation.
type CapacityReservationStatus string

const (
	// CapacityReservationStatusPending indicates the reservation is pending.
	CapacityReservationStatusPending CapacityReservationStatus = "PENDING"
	// CapacityReservationStatusActive indicates the reservation is active.
	CapacityReservationStatusActive CapacityReservationStatus = "ACTIVE"
	// CapacityReservationStatusCancelled indicates the reservation is cancelled.
	CapacityReservationStatusCancelled CapacityReservationStatus = "CANCELLED"
	// CapacityReservationStatusExpired indicates the reservation is expired.
	CapacityReservationStatusExpired CapacityReservationStatus = "EXPIRED"
	// CapacityReservationStatusFailed indicates the reservation failed.
