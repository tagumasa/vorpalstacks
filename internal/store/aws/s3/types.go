...
// ReplicationConfiguration specifies the cross-region replication configuration for a bucket.
...
// ReplicationFilter filters which objects are replicated.
type ReplicationFilter struct {
	Prefix      string                  `json:"prefix,omitempty"`
	Tag         *ReplicationTagFilter   `json:"tag,omitempty"`
	AndOperator *ReplicationAndOperator `json:"and_operator,omitempty"`
}

// ReplicationTagFilter is a tag-based filter for replication.
type ReplicationTagFilter struct {
	Key   string `json:"key,omitempty"`
	Value string `json:"value,omitempty"`
}

// ReplicationAndOperator combines multiple filter conditions.
type ReplicationAndOperator struct {
	Prefix string                 `json:"prefix,omitempty"`
	Tags   []ReplicationTagFilter `json:"tags,omitempty"`
}

// ReplicationDestination is the destination bucket for replication.
