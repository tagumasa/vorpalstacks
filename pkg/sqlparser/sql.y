...
| object_property_list ',' object_property
  {
    $$ = append($1, $3)
  }
...
object_property:
  STRING ':' expression
  {
    $$ = &ObjectProperty{Key: &SQLVal{Type: StrVal, Val: $1}, Value: $3}
  }
| sql_id ':' expression
  {
    $$ = &ObjectProperty{Key: &ColName{Name: $1}, Value: $3}
  }
