...
- **ACM**: ExportCertificate now passes base64-decoded passphrase bytes to encryptPrivateKey (was passing the raw base64-encoded string, causing PBKDF2 key mismatch and client-side decryption failures).
