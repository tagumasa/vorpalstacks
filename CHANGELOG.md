...
- **Cognito Identity**: GetOpenIdTokenForDeveloperIdentity TokenDuration clamp range corrected from 15–3600 to AWS-spec 1–86400 seconds.
...
- **STS**: resolveCallerIdentity now falls back to STS session lookup for temporary credentials (was only checking IAM permanent access keys, breaking role-chaining identity resolution).
