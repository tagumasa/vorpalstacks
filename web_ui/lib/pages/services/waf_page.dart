...
import '../../providers/waf_provider.dart';

class WAFPage extends ConsumerWidget {
  const WAFPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final state = ref.watch(wafListProvider);
    final notifier = ref.read(wafListProvider.notifier);
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Manage WAF Classic web access control lists',
              style: TextStyle(
                fontSize: 14,
  ...
  Widget _buildWebAclCard(BuildContext context, WAFWebACL acl) {
    final cs = Theme.of(context).colorScheme;
